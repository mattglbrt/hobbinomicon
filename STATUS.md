...
- **`.claude/commands/{orient,wrap}.md` are tracked in git** — swept in by a `git add -A` on 07-28, outside that commit's scope. Untrack + `.gitignore` if they should stay local. (Carried from 07-28.)
