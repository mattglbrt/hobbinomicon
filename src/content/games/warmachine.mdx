...
# Only army-scale entry in the directory, so scored suggestions have no
# format peer to work with and fall back to thin tag overlap. Off until there's
# a comparison worth making — remove this or add relatedGames to bring it back.
hideFunnel: true
...
The links that are not already in the reference card above. Folded in from the
old resources page, which now redirects here.

- **[Warmachine Academy](https://warmachineacademy.miraheze.org/wiki/Main_Page)** —
  start here. The community wiki: MK4 guides, faction breakdowns, everything a
  new or returning player needs.
- **[WarTable Online](https://wartable.online/)** — play Warmachine online, free.
- **[Community finder](https://sites.google.com/view/warmachine-community-finder/home)** —
  find local players and groups.
- **[Main community Discord](https://discord.gg/PRhCt3vduz)** — the largest server.
  **[Brawlmachine](https://discord.gg/TdwHBnrGQd)** for the smaller format, and
  **[Delaware Warmachine](https://discord.gg/nmZSV5jMtu)**.
- **[Warmachine Unlimited](https://www.facebook.com/groups/567359041956196/)** —
  legacy format community.
  **[Buy/sell/trade](https://www.facebook.com/share/g/1Cz1j5Doqp/)** on Facebook.
- **[YouTube](https://www.youtube.com/channel/UCcLPbHAOgtN5tF5kpNuokEw)**,
  **[Instagram](https://www.instagram.com/warmachinegame/)** and
  **[TikTok](https://tiktok.com/@warmachinegame)** — official channels.
