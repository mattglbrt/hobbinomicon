...
videoTitle: "Paint a Trench Pilgrim Warband in 2 Hours"
topic: "painting"
game: "trench-crusade"
difficulty: "beginner"
legacySlug: "blog/vlogs/paint-a-trench-pilgrim-warband-in-2-hours"
timeMinutes: 120
materials:
  - name: "Broadsword Silver (Army Painter Speedpaint)"
  - name: "Battleship Grey (Army Painter Speedpaint)"
  - name: "Blood Angels Red (Citadel Contrast)"
  - name: "Molotow Liquid Chrome"
  - name: "Streaking Grime"
  - name: "Mithril Silver"
  - name: "Makeup sponge"
steps:
  - "Do the metal first, in Broadsword Silver across the whole warband. Doing it first means you clean the metal flakes out of your water before anything else."
  - "Stipple Molotow Liquid Chrome onto masks and helmets in select spots only. It reads as real metal and it is easy to overdo."
  - "Paint all clothing Battleship Grey and all capes and hoods Blood Angels Red. Over a zenithal you get high contrast without slap chop."
  - "Be sloppy on purpose. The method does not need you to stay inside the lines."
  - "Slather everything in streaking grime."
  - "Wipe back with a makeup sponge, up and down, thinking about where light lands. Take more off shoulders, heads and arms than the underside of a robe."
  - "Drybrush Mithril Silver over all metal, gold included. Gold shimmers in life, so silver over it reads more real, not less."
---

{/* MATT: topic guessed as "painting" — tags were [trench-crusade, tutorial, speed-painting, streaking-grime, metallics]. Confirm or change. */}
