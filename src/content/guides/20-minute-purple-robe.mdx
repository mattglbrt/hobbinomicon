...
videoTitle: "20 Minute Purple Robe"
topic: "painting"
difficulty: "beginner"
legacySlug: "blog/vlogs/20-minute-purple-robe"
timeMinutes: 20
materials:
  - name: "Moody Mauve (Army Painter Speedpaint)"
  - name: "Vanilla White"
steps:
  - "Brush prime, then drybrush with a warm white."
  - "Sketch more white in at the top of the robe, where the light lands."
  - "Glaze Moody Mauve over the top."
  - "Force the contrast further than feels comfortable. Blending too smoothly is what flattens a robe out, because the shadows and highlights end up too close together."
---
