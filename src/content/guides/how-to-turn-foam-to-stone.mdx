...
videoTitle: "How to Turn Foam to Stone"
topic: "basing-and-terrain"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-turn-foam-to-stone"
materials:
  - name: "AK Natural Texture for Earth"
  - name: "Small spatula"
  - name: "Card stock"
  - name: "Grey primer"
steps:
  - "Fill the open foam cells on the cut faces with AK Natural Texture, worked in with a spatula. Skip this and every one of those pores shows up under paint."
  - "Glue card stock offcuts under the bases for rigidity."
  - "Let it dry. Going on thin gives you cracking, which is usually what you want in stone. Two layers if you do not."
  - "Prime grey, a couple of coats."
---
