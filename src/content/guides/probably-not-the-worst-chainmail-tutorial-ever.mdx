...
tags: ["metallics","chainmail","painting","speed-painting","dry-brushing","historical-miniatures","tutorial"]
videoTitle: "Probably Not the Worst Chainmail Tutorial Ever"
topic: "painting"
difficulty: "beginner"
legacySlug: "blog/vlogs/probably-not-the-worst-chainmail-tutorial-ever"
timeMinutes: 60
materials:
  - name: "Broadsword Silver (Army Painter Speedpaint)"
  - name: "Vallejo Air Silver"
  - name: "Molotow Liquid Chrome"
steps:
  - "Base the weapons, helmets and mail in Broadsword Silver."
  - "Drybrush Vallejo Air Silver. Work the paint into the bristles rather than just wiping it off, so you can hit from several angles."
  - "Hit the shield boss and a few scratches with Molotow Liquid Chrome, stippling with very little on the brush. It is easy to overdo."
---
