...
tags: ["basing","3d-printing","midgard","vallejo","tutorial"]
videoTitle: "Scenic and Magnetic Movement Trays Part 1"
topic: "sculpting-casting-3d-printing"
difficulty: "beginner"
legacySlug: "blog/vlogs/scenic-and-magnetic-movement-trays-part-1"
materials:
  - name: "Flexible steel sheet"
  - name: "Razor knife"
  - name: "Mr. Surfacer, black"
  - name: "Vallejo mud texture paste"
  - name: "Magnets, for the model bases"
steps:
  - "Use flexible steel for the tray, not magnetic sheet. The magnets go in the model bases; the tray is what they stick to."
  - "Lay the sheets out first to work out a layout that needs the fewest cuts."
  - "To cut, fold on the line, crease it with a razor knife, then pull straight back. It snaps clean."
  - "Sand the tray edges and paint them black with Mr. Surfacer."
  - "Bevel the steel edges unevenly with a flexible razor knife, so the mud has somewhere to graduate into instead of stopping at a hard edge."
  - "Apply Vallejo mud texture paste over the top. It hides the steel entirely, which is the point. It also takes forever to dry."
---
