...
tags: ["painting","children-of-gomb","scale-75","crafts","inq28"]
videoTitle: "Painting Chaosy Green Marble"
topic: "painting"
legacySlug: "blog/vlogs/painting-chaosy-green-marble"
difficulty: "intermediate"
materials:
  - name: "Pastel Green (Scale Color)"
  - name: "Lime Green (Scale Color)"
  - name: "Alizarin Green (Scale Color)"
  - name: "Golden High Flow Translucent Gold Green"
  - name: "Vanilla White (Scale Color)"
  - name: "Large makeup brush"
steps:
  - "Leave some of the black undercoat showing through deliberately. The gaps are the marble."
  - "Mix the greens with white and dab them on, then blend with a big makeup brush. Scale Color acrylics let you work them like oils."
  - "Keep your water dirty on purpose. Purple-tinted water tints everything slightly and helps the translucency."
  - "Edge highlight everything in vanilla white."
  - "Stipple brighter highlights on the key edges only, where the eye lands."
---
