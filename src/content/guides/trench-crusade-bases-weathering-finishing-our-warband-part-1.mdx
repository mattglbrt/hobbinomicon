...
tags: ["trench-crusade","weathering","tutorial","basing"]
project: "trench-pilgrims"
videoTitle: "Trench Crusade Bases & Weathering - Finishing our Warband Part 1"
topic: "basing-and-terrain"
game: "trench-crusade"

legacySlug: "blog/vlogs/trench-crusade-bases-weathering-finishing-our-warband-part-1"
difficulty: "intermediate"
materials:
  - name: "Tamiya Weathering Master, orange rust / gunmetal / silver"
  - name: "Nihilakh Oxide (Citadel)"
  - name: "Brownish Decay (Army Painter Speedpaint)"
  - name: "Matte coat"
steps:
  - "Do pigments first, matte coat second, and glossy effects like blood last. That order stops the matte spray killing the shine you just added."
  - "Brush Tamiya Weathering Master on like a drybrush. It is a very fine powder and it puts the shine back on metal."
  - "Go carefully with Nihilakh Oxide. It is easy to overdo and lose everything underneath it."
  - "Pluck the edges of a bit of foam and use that for the uneven application rather than a clean sponge."
  - "Use Brownish Decay as a chipping medium: hit it while it is wet again and stipple."
  - "Where paint chips off higher than it should, make it deliberate with stippling and quick strokes rather than trying to hide it."
---
