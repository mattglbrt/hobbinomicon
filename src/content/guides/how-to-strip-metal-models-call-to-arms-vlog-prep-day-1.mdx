...
tags: ["stripping","tutorial","competition"]
videoTitle: "How to Strip Metal Models | Call to Arms Vlog Prep Day 1"
topic: "painting"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-strip-metal-models-call-to-arms-vlog-prep-day-1"
materials:
  - name: "Acetone"
  - name: "Cone paper filter"
  - name: "Old toothbrush"
steps:
  - "Soak the models in acetone."
  - "Pull them out and brush them down."
  - "Filter the acetone through a cone filter. It catches the tiny bits and lets you reuse it."
  - "Put everything back in and repeat."
  - "Wash off with water."
---

{/* MATT: topic guessed as "painting" — tags were [stripping, tutorial, competition]. Confirm or change. */}
