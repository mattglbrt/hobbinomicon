...
videoTitle: "How to Marble Paper"
topic: "painting"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-marble-paper"
materials:
  - name: "Carrageenan"
  - name: "Kodak Professional Photo-Flo"
  - name: "100lb cover stock"
  - name: "Large calligraphy brush"
  - name: "Plastic twine bundles"
steps:
  - "Make the size: carrageenan in water. It is ground seaweed, and it raises the surface tension enough that ink floats and sets into the paper."
  - "Add a very small amount of Photo-Flo to the ink. It breaks surface tension, and that is what makes the cells."
  - "Flick ink onto the surface with the calligraphy brush, then the smaller brushes."
  - "Comb or rake the pattern with bundles of plastic twine if you want traditional patterns rather than stone."
  - "Lay the sheet on, lift it straight off, and hang it to dry."
  - "Press the sheets afterwards. They dry badly curled."
---

{/* MATT: topic guessed as "painting" — tags were [crafts, tutorial]. Confirm or change. */}
