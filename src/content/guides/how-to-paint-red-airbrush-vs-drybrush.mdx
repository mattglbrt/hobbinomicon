...
tags: ["tutorial","orcs-and-goblins","airbrushing","dry-brushing","painting","speed-painting"]
videoTitle: "How to Paint Red - Airbrush vs Drybrush"
topic: "airbrushing"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-paint-red-airbrush-vs-drybrush"
timeMinutes: 33
materials:
  - name: "Hex Lyken (purple)"
  - name: "Burnt Umber"
  - name: "A red"
  - name: "Yellow ochre ink"
  - name: "Cheap violet craft paint"
  - name: "Mineral spirits"
  - name: "Soft-bristle drybrush"
steps:
  - "Prime black and hit it from the top with rattle-can white. You do not need an airbrush for this part."
  - "Preshade with Hex Lyken purple, coming up from the bottom as a reverse highlight."
  - "Lay Burnt Umber over it. Going straight from white to red skips a step you will miss."
  - "Build the red up traditionally. If you are drybrushing rather than airbrushing, use far more paint than a normal drybrush and a soft bristle so you do not leave strokes."
  - "Highlight with orange and yellow ochre ink."
  - "Tie it together with a very thin purple oil wash: cheap violet craft paint and mineral spirits. This is the step that makes the drybrushed one indistinguishable from the airbrushed one."
---
