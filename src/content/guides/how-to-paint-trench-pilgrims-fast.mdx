...
tags: ["trench-crusade","tutorial","washes","streaking-grime","speed-painting","skin-tones"]
project: "trench-pilgrims"
videoTitle: "How to Paint Trench Pilgrims Fast"
topic: "painting"
game: "trench-crusade"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-paint-trench-pilgrims-fast"
timeMinutes: 15
materials:
  - name: "Battleship Grey (Army Painter Speedpaint)"
  - name: "Flesh Wash (Army Painter)"
  - name: "Bony Matter (Army Painter)"
  ...
  - name: "Makeup sponge"
steps:
  - "Base the clothes in Battleship Grey."
  - "Mix Flesh Wash and Bony Matter and put it on all the flesh: feet, hands, chest."
  - "For the oil route, mix burnt umber and black into a modified Zorn palette, thin with mineral spirits, and work it into the recesses."
  - "For the acrylic route, lather the model in streaking grime and let it sit."
  - "Wipe back with a makeup sponge, going left to right across the model. Up and down catches on arms and snaps them off."
  - "Drybrush metallic silver over helmets and chains."
---

{/* MATT: topic guessed as "painting" — tags were [trench-crusade, tutorial, washes, streaking-grime, speed-painting, skin-tones]. Confirm or change. */}
