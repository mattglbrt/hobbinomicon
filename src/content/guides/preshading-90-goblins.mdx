...
tags: ["airbrushing","orcs-and-goblins","warhammer"]
project: "orcs-and-goblins-army"
videoTitle: "Preshading 90 Goblins"
topic: "airbrushing"
hub: "warhammer"
difficulty: "beginner"
legacySlug: "blog/vlogs/preshading-90-goblins"
materials:
  - name: "Hex-lichen"
  - name: "Purple ink"
  - name: "White"
steps:
  - "Get everything not being sprayed out of the overspray zone, and sort as you go — robed models need more airbrush work than bare ones."
  - "Hit everything with hex-lichen from below."
  - "Come from above with purple ink, standard zenithal."
  - "Final hit from the top with white mixed into the ink."
  - "Let each coat of ink dry properly. Rushing the last one mottles whatever colour goes over it."
---
...
So I'm going to slot you in um and I'm going to get to work. So, we're going to come up from the bottom with hex len. We're going to come down from the top with our or actually we'll do a zenithal. We'll do purple up and then white down. I got a lot of fans going.
