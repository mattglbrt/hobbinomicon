...
tags: ["painting","metallics","dry-brushing","monolith-bearer"]
videoTitle: "How to Paint Bronze Part 2"
topic: "painting"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-paint-bronze-part-2"
materials:
  - name: "Pure silver"
  - name: "Bright brass"
  - name: "Copper"
steps:
  - "Drybrush pure silver on the raised corners and nails, where the light actually hits."
  - "Mix bright brass into the silver and go back over the same areas. The layering tints them and reads as polished metal."
  - "Drybrush bright brass on its own."
  - "Mix bright brass with the original copper base and unify the whole piece with one final drybrush. That is what tells the eye it is all one metal."
---
