...
tags: ["ttrpg","solo-rpg"]
videoTitle: "Solo Roleplaying Session 0 Part 1: Intro to the System"
topic: "solo-rpg"
difficulty: "beginner"
legacySlug: "blog/vlogs/solo-roleplaying-session-0-part-1-intro-to-the-system"
steps:
  - "Read the ruleset front to back before session zero. Solo play has nobody to ask."
  - "Set up your oracle: the tables or deck you will use to answer questions the rules do not."
  - "Decide how you are recording the session. The written record is the game in solo play."
  - "Roll your character and let the results steer the fiction rather than fighting them."
---
