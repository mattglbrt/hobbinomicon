...
tags: ["crafts","kal-arath","tutorial"]
heroImage: "/images/hero-cache/olUDGc3KdSQ.jpg"
videoTitle: "Making Zines Is Easy with the Right Tools"
topic: "painting"
game: "kal-arath"
difficulty: "beginner"
legacySlug: "blog/vlogs/making-zines-is-easy-with-the-right-tools"
materials:
  - name: "Scoring board"
  - name: "Saddle stitch stapler (Bostitch)"
  - name: "Hole-punching jig, for Coptic binding"
  - name: "Waxed thread (Maine Thread Company)"
  - name: "A good rock, with a notch"
steps:
  - "Score every fold on a scoring board before you fold anything. This is the difference between a zine and a stack of bent paper."
  - "Saddle stitch through the spine with a long-arm stapler."
  - "For a Coptic binding, punch the holes with a jig so they line up across signatures."
  - "Sew with waxed thread. Unwaxed drags and frays."
  - "Weight the finished book while the spine settles. A rock with a notch in it works better than a press."
---

{/* MATT: topic guessed as "painting" — tags were [crafts, kal-arath, tutorial]. Confirm or change. */}
