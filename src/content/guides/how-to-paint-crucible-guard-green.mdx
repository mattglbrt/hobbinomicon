...
tags: ["airbrushing","speed-painting","crucible-guard","warmachine","tutorial","army-painter"]
videoTitle: "How to Paint Crucible Guard Green"
topic: "airbrushing"
game: "warmachine"
hub: "warmachine"
faction: "Crucible Guard"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-paint-crucible-guard-green"
timeMinutes: 30
materials:
  - name: "Tyrant Navy (Speedpaint 2.0)"
  - name: "Plasmatic Bolt (Speedpaint 2.0)"
  - name: "Thunderbird Blue (Speedpaint 2.0)"
  - name: "White ink"
  - name: "Airbrush"
steps:
  - "Zenithal prime the model black to white. The more contrast you leave, the fewer colours you need on top."
  - "Airbrush Thunderbird Blue over the white zenithal highlight. This is the brightest point, and everything after it works backwards into shadow."
  - "Build shadows with Plasmatic Bolt, spraying up from the bottom and staying well clear of the top of the model."
  - "Go deeper with Tyrant Navy in the deepest recesses. Barely touch the trigger — the contrast is high enough that a little goes a long way."
  - "Spraying bottom-up leaves an edge highlight on its own. Let it."
  - "If the airbrush speckles, go back over it with the first highlight colour plus a little white ink to smooth the transition."
---
...
Crucible Guard is the faction I paint samples from rather than field, so this
recipe is the one I keep coming back to. The rest of my
[Warmachine painting guides](/warmachine/) work the same way, and there are more
[airbrushing guides](/guides/airbrushing/) if you want to get the transitions
smoother. [Warmachine is in the directory](/games/warmachine/) if you want the
game itself.
