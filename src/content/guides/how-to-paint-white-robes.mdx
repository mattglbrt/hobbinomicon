...
tags: ["painting","cloth","glazing","orcs-and-goblins","airbrushing","basing"]
heroImage: "/images/hero-cache/TdGbVjFl4oA.jpg"
videoTitle: "How to Paint White Robes"
topic: "airbrushing"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-paint-white-robes"
materials:
  - name: "Buff"
  - name: "Vanilla White"
steps:
  - "Start over a purple and red base coat rather than a grey one. The warmth underneath is what stops white cloth reading as dead."
  - "Glaze buff over the top, leaving the deepest folds in shadow."
  - "Let the buff sit out a while before you use it. Slightly thickened, it handles far better for this than straight from the pot."
  - "Glaze vanilla white on the ridges only."
  - "Leave the bottom of the robe mostly in shadow. Only the part catching light needs to go all the way up."
---
...
White cloth over a coloured base coat, not over grey. The purple and red
underneath do the shadow work for you, and they keep the white from going
chalky the way it does over a neutral undercoat.

This is a tabletop-standard job on models whose role is to walk forward and
die, so it is two colours and a handful of glazes. Buff for the bulk of it,
vanilla white on the ridges, and the deep folds left alone.

The tip worth stealing is letting the buff sit out on the palette for a while
first. Straight from the pot it is too thin for this; an hour later it has
thickened just enough to sit where you put it.
