...
videoTitle: "How to Create a Dolmenwood Character"
topic: "painting"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-create-a-dolmenwood-character"
steps:
  - "Roll ability scores and note the modifiers."
  - "Pick an alignment. It carries mechanical weight — decisiveness gives plus one to retainer loyalty."
  - "Roll background and trinket."
  - "Fill in class details: prime ability, hit dice, starting equipment."
  - "Choose a starting spell book if your class has one, and tie it to the background you rolled."
  - "Note skills and languages. Skills default to 6, and native languages come from your kindred."
  - "Roll equipment: rations, water skin, belt pouch with 3d6 gold, and up to four adventuring items."
  - "Roll a moon sign. Waxing, full and waning each do something different."
  - "Work out combat stats: AC, attack, encumbrance and speed."
---

{/* MATT: topic guessed as "painting" — tags were [dolmenwood, ttrpg, tutorial]. Confirm or change. */}
