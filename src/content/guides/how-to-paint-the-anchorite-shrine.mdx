...
videoTitle: "How to Paint the Anchorite Shrine"
topic: "basing-and-terrain"
game: "trench-crusade"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-paint-the-anchorite-shrine"
timeMinutes: 180
materials:
  - name: "Purple, for the preshade"
  - name: "Silver speedpaint"
  - name: "White primer"
  - name: "Guilliman Flesh (Citadel Contrast)"
  - name: "Plaguebearer Flesh (Citadel Contrast)"
  - name: "Blood Angels Red (Citadel Contrast)"
  - name: "Streaking Grime"
  - name: "Sprue sponge"
steps:
  - "Drybrush purple into all the shadows first. The silver speedpaint has purple in it, so the preshade carries through instead of fighting it."
  - "Build the silver up slowly over the top so no brush strokes show."
  - "Block in white primer anywhere that is not going to be metal: the wood, and anything destined for gold."
  - "Mix Guilliman Flesh and Plaguebearer Flesh for aged wood, and go on sloppy. Over a purple zenithal it does the work for you."
  - "Put Blood Angels Red on the hood. On a shrine that is the one colour tying it to the rest of the warband."
  - "Sketch the highlights in with white primer before the grime goes on. The grime blends them and you get highlights for almost no effort."
  - "Slather streaking grime over everything, then take most of it off with a sprue sponge."
---
