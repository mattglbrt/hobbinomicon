...
videoTitle: "How to Make Scratch Built Terrain Indestructible"
topic: "basing-and-terrain"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-make-scratch-built-terrain-indestructible"
materials:
  - name: "Elmer's glue"
  - name: "Isopropyl alcohol"
  - name: "Mod Podge matte"
  - name: "Grey or black primer"
steps:
  - "Seal with a straight layer of Elmer's glue first. Everything else keys into this."
  - "Follow with 50/50 water and glue plus a little isopropyl alcohol, which breaks the surface tension so it flows instead of beading."
  - "Repeat that layer about four times."
  - "Finish with Mod Podge matte mixed with grey primer. Brush it rather than spray it wherever pink foam is exposed, or the propellant melts it."
  - "If it goes on too thick, dab the excess off with a paper towel and spread what is left."
---
