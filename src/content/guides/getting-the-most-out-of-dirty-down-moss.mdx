...
tags: ["dirty-down","weathering","terrain","tutorial"]
project: "motley-crews"
projectSection: "The Board"
videoTitle: "Getting the Most Out of Dirty Down Moss"
topic: "basing-and-terrain"
difficulty: "beginner"
legacySlug: "blog/vlogs/getting-the-most-out-of-dirty-down-moss"
materials:
  - name: "Dirty Down Moss"
  - name: "Static grass tufts"
  - name: "Heat gun"
  - name: "AK Interactive paste"
steps:
  - "Shake the moss hard before you start."
  - "Hit the board with a heat gun as you apply it. The moss bubbles up and that is the effect you are paying for."
  - "For long static grass, pinch a clump in the middle and glue it at the pinch. One clump gives you two tufts."
  - "Place matching blocks apart rather than together. The eye reads the gap as a slope where water would collect."
  - "To reactivate later, just wet it. You do not need more product."
  - "Watch the heat setting. The high setting melts foam, and gap-filling with AK paste afterwards is a worse day than going slow."
---
