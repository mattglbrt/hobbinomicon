...
tags: ["painting","skin-tones","scale-75","sculpting","children-of-gomb","inq28"]
videoTitle: "Painting Creepy Cartoonish Skin"
topic: "sculpting-casting-3d-printing"

legacySlug: "blog/vlogs/painting-creepy-cartoonish-skin"
difficulty: "intermediate"
steps:
  - "Work the skin up with a peachy light tone mixed into the midtone."
  - "Glaze the midtone back over everything between passes to keep it unified."
  - "Stipple rather than edge highlight. Stippling is edge highlighting for skin."
  - "Load the brush by dragging it through the paint and swirling to a point, keeping paint only halfway up the belly of the bristles."
---
