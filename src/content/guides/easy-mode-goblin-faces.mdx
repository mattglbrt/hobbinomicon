...
tags: ["painting","tutorial","orcs-and-goblins","skin-tones","speed-painting","warhammer"]
project: "orcs-and-goblins-army"
videoTitle: "Easy Mode Goblin Faces"
topic: "painting"
hub: "warhammer"
difficulty: "beginner"
legacySlug: "blog/vlogs/easy-mode-goblin-faces"
timeMinutes: 8
materials:
  - name: "Lime Green (Scale Color)"
  - name: "Vallejo Air White"
  - name: "Burnt umber"
  - name: "Squid Pink"
  - name: "Arctic Blue (Scale Color)"
steps:
  - "Start from a face already based in Shamrock Green over a yellow and black preshade."
  - "Glaze lime green at skim-milk consistency onto the raised edges, pulling from the shadows out to where the light hits hardest."
  - "Go in thick with white on the teeth. The yellow and purple underneath have already done the shading for you."
  - "Wash the teeth with very thin burnt umber and let it pool in the ridges. Pull the excess off with capillary action."
  - "Mix a little white into the wash colour and dab the very bottoms of the teeth, keeping brown in the cracks and at the gums."
  - "Paint the gums Squid Pink, thick, angling the brush to use whatever imperfections the bristles have."
  - "Put Arctic Blue on the bottom lip with the curve of the brush, then stipple for texture."
  - "Optionally glaze a very thin pink under the nose, but only once the green is bone dry or it will water-stain."
---
