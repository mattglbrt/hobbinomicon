...
tags: ["painting","washes","weathering","monolith-bearer","midgard"]
videoTitle: "How to Paint Talons & Toesies"
topic: "painting"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-paint-talons-and-toesies"
materials:
  - name: "Bright brass"
  - name: "Base brown"
  - name: "Warm white"
steps:
  - "Carry the brass scratches from the body up onto the helmet so the metal reads as one material."
  - "Go in on the talons and hooves with the base brown, thick and on a fairly dry brush so you are not doing many passes."
  - "Bring the paint to a point on the brush for the toes."
  - "Finish with a few hits of warm white on the very tips of the talons and the raised areas."
---
