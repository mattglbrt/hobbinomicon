...
tags: ["3d-printing","resin-casting","tutorial","workspace"]
videoTitle: "How I Clean My Resin 3D Prints"
topic: "sculpting-casting-3d-printing"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-i-clean-my-resin-3d-prints"
materials:
  - name: "Denatured or methylated ethanol, per your resin's MSDS"
  - name: "Elegoo wash and cure station"
  - name: "Tupperware containers"
  - name: "Drain tray"
steps:
  - "Let the plate drain over a tray first. Keep the tray in a ziplock, cure it outside, and reuse it."
  - "Dip the plate in a Tupperware of dirty alcohol before the main wash. That container takes the worst of the resin so the good wash stays usable."
  - "Wash in ethanol, not isopropyl. Check your resin's MSDS — Siraya Tech Build asks for ethyl alcohol."
  - "Rinse in hot water in a separate container and snap the supports off in there."
  - "Leave the prints overnight in a closed room to evaporate off. This is the step everyone skips and it is the one that matters."
  - "A clean print looks matte. Any gloss is uncured resin left behind, not the finish."
---
