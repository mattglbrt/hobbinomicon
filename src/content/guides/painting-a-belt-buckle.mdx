...
videoTitle: "Painting an NMM Belt Buckle With Scale 75 Grays"
topic: "painting"

legacySlug: "blog/vlogs/painting-a-belt-buckle"
difficulty: "intermediate"
materials:
  - name: "Kimera artist greys: art white, art black, buff"
steps:
  - "Leave the black primer showing in the recesses. That is your black lining, and it costs nothing."
  - "Rest your wrist on the table and cup the model. Brush control is posture before it is anything else."
  - "Paint where an edge highlight would go, then a little beyond it, using the stroke itself to suggest the reflection."
  - "Use the box art to decide where the reflection falls rather than guessing."
  - "Think in values, not in colours. Metal is not a colour you paint, it is a set of reflections you place."
---
