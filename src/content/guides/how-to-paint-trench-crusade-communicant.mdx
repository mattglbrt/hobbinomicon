...
videoTitle: "How to Paint Trench Crusade Communicant"
topic: "painting"
game: "trench-crusade"
difficulty: "beginner"
legacySlug: "blog/vlogs/how-to-paint-trench-crusade-communicant"
timeMinutes: 60
materials:
  - name: "Broadsword Silver (Army Painter Speedpaint)"
  - name: "Half Gold (Army Painter Speedpaint)"
  - name: "Burnt umber oil paint"
  - name: "Black oil paint"
  - name: "Yellow ochre oil paint"
  - name: "Blue oil paint"
  - name: "White oil paint"
  - name: "Mineral spirits"
  - name: "Makeup sponge"
  - name: "Filbert brush"
steps:
  - "Base all metal in Broadsword Silver, then touch up with Half Gold. Let it dry."
  - "Mix burnt umber, black and yellow ochre oils into a brown and slather it over every piece of metal. Add more black and mineral spirits where you want it to flow into recesses."
  - "Mix blue into the same palette for the skin. Trench Crusade art reads blue-tinted, and this is how you get there."
  - "Wipe it back with a makeup sponge after about ten minutes. Go heavy on the skin; let some brown mix into hands and torso."
  - "Highlight with mostly white and a little blue on the tops of muscles, fingertips and knuckles."
  - "Feather the highlights into the midtones with a filbert brush."
---

{/* MATT: topic guessed as "painting" — tags were [trench-crusade, tutorial, washes, skin-tones]. Confirm or change. */}
