...
videoTitle: "How to Use Dirty Down Rust + Creating Blood & Gore - Part 2"
topic: "painting"
game: "trench-crusade"

legacySlug: "blog/vlogs/how-to-use-dirty-down-rust-creating-blood-gore-part-2"
difficulty: "intermediate"
materials:
  - name: "Dirty Down Rust"
  - name: "Mithril Silver"
  - name: "UHU Universal Adhesive"
  - name: "Blood Angels Red (Citadel Contrast)"
  - name: "Heat gun"
  - name: "Disposable glove"
steps:
  - "Seal and matte the model first."
  - "Apply Dirty Down Rust a section at a time, then hit it with the heat gun."
  - "Reactivate with plain water on the brush: dab, stipple, wet it a little, heat gun again. This pulls rust off the tips and leaves it in the recesses."
  - "Drybrush Mithril Silver very lightly over the built-up areas. Get most of the paint off on a sponge first."
  - "For gore, put UHU adhesive on a gloved fingertip and swipe it to pull thin strands."
  - "Stipple Blood Angels Red into the glue with a brush you do not care about, or a gloved finger."
---

{/* MATT: topic guessed as "painting" — tags were [dirty-down, weathering, trench-crusade, tutorial]. Confirm or change. */}
