...
tags: ["airbrushing","speed-painting","army-painter","historical-miniatures"]
videoTitle: "Airbrushing Speed Paints to Easy Mode Horses"
topic: "airbrushing"
difficulty: "beginner"
legacySlug: "blog/vlogs/airbrushing-speed-paints-to-easy-mode-horses"
timeMinutes: 45
materials:
  - name: "Warrior Flesh (Army Painter Speedpaint)"
  - name: "A peachy flesh tone"
  - name: "Yellow (Army Painter Speedpaint)"
steps:
  - "Start from a zenithal highlight."
  - "Lay the peachy flesh tone in from the top."
  - "Come up from the bottom with Warrior Flesh, alternating with the peach from above at each pass."
  - "Go over the top carefully with straight yellow speedpaint. Vary how far you take it per model and you get three horses that read as different animals rather than three of the same one."
  - "Watch for water left in the airbrush or the cup. It thins the speedpaint and you lose the colour."
---
