...
tags: ["3d-printing"]
videoTitle: "Working with 3D Prints"
topic: "sculpting-casting-3d-printing"
difficulty: "beginner"
legacySlug: "blog/vlogs/working-with-3d-prints"
materials:
  - name: "Superglue"
  - name: "Heat gun"
  - name: "Sanding stick"
steps:
  - "Look the print over for support nubs and print errors before anything else. There are no mould lines to worry about, but there are both of those."
  - "Use superglue. Plastic cement does nothing on resin."
  - "For a warped or broken part, sand the join flush, warm it with a heat gun, and bend it back into position."
  - "Straighten anything bent in the same way before priming."
---
