...
description: "Putting Manalone's Prima Materia dice to work — Garen and the praying mantis bond, get caught in a thunderstorm, find a desecrated giant skull, and fight off two cultists in a hand-drawn cave."
...
Manalone wrote and conceived **Prima Materia**. Dice Nest made these amazing dice. I want to do a full review, but I want to use them more first. I've read the book cover to cover three times now and I'm still finding more.
